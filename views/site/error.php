...
<h4>Здесь пока что пусто!</h4>
<p>Извините, эта страница на данный момент не работает (никогда и не заработает)...</p>
<a class="homepage" href="http://127.0.0.1/hr_agency/web/"><i class="fas fa-home"></i>
На главную</a>
</div>
